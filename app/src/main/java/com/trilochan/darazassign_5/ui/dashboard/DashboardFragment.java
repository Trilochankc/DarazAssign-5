package com.trilochan.darazassign_5.ui.dashboard;
...
import com.trilochan.darazassign_5.ClassInterface.RetrofitInterface;
...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        AdapterFlash FlashAdapter = new AdapterFlash(getActivity(), contactsList);
    ...
    public void product_function(){
        ...
        modalCollectionCall.enqueue(new Callback<ProductCollectionModal>() {
            ...
            public void onResponse(Call<ProductCollectionModal> call, Response<ProductCollectionModal> response) {
                ...
                AdapterProduct recyclerviewAdapter = new AdapterProduct(getActivity(),response.body().darazProductModalClasses());
